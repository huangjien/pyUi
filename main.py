...
class App(tk.Tk):
    def __init__(self):
        ...
        self.initSettingsTab(tabSettings)

        self.initInstancesTab(tabInstances)

        self.initScriptsTab(tabScripts)

        self.initLogsTab(tabLogs)

        tab_control.pack(expand=1, fill='both')

    def initScriptsTab(self, tabScripts):
    ...
    def initInstancesTab(self, tabInstances):
    ...
    def initSettingsTab(self, tabSettings):
        ...
        set.grid(column=0, row=1, columnspan=4, sticky='ew')
